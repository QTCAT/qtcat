...
#' @param min.absCor Minimum absolute value of correlation considered. A value in the range 
#' from 0 to 1.
#'
#' @examples
...
#' exist a design matrix of those. This is needed for \code{\link{qtcatHit}} as input.
#'
...
#' phenotype e.g. environmental and experimental components.
#'
#' @examples
...
#' @param alpha A single value or a vector of values in the range of 0 to 1 for the elastic 
